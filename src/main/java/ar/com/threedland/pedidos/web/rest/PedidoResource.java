...
/**
 * REST controller for managing {@link ar.com.threedland.pedidos.domain.Pedido}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Pedido> result = pedidoRepository
            ...
            .map(existingPedido -> {
                ...
                if (pedido.getCostoTotal() != null) {
                    existingPedido.setCostoTotal(pedido.getCostoTotal());
                }
                if (pedido.getPrecioVenta() != null) {
                    existingPedido.setPrecioVenta(pedido.getPrecioVenta());
                }
                if (pedido.getGananciaTotal() != null) {
                    existingPedido.setGananciaTotal(pedido.getGananciaTotal());
                }
