...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof ar.com.threedland.pedidos.service.EmailAlreadyUsedException ||
            ex instanceof ar.com.threedland.pedidos.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof ar.com.threedland.pedidos.service.InvalidPasswordException
