...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, ar.com.threedland.pedidos.domain.Pedido.class.getName() + ".detallePedidos");
            createCache(cm, ar.com.threedland.pedidos.domain.Pedido.class.getName() + ".estadoPedidos");
            ...
            createCache(cm, ar.com.threedland.pedidos.domain.Producto.class.getName() + ".detallePedidos");
