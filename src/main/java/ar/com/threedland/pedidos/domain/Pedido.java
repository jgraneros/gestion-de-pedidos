...
public class Pedido implements Serializable {
    ...
    private Set<DetallePedido> pedidos = new HashSet<>();
    ...
    public Set<DetallePedido> getPedidos() {
        return this.pedidos;
    }

    public void setPedidos(Set<DetallePedido> detallePedidos) {
        if (this.pedidos != null) {
            this.pedidos.forEach(i -> i.setPedido(null));
        }
        ...
        this.pedidos = detallePedidos;
    }

    public Pedido pedidos(Set<DetallePedido> detallePedidos) {
        this.setPedidos(detallePedidos);
        return this;
    }

    public Pedido addPedido(DetallePedido detallePedido) {
        this.pedidos.add(detallePedido);
        detallePedido.setPedido(this);
        return this;
    }

    public Pedido removePedido(DetallePedido detallePedido) {
        this.pedidos.remove(detallePedido);
