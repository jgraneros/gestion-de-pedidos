  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="gestionPedidosApp.location.home.createOrEditLabel"
          data-cy="LocationCreateUpdateHeading"
          v-text="t$('gestionPedidosApp.location.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('gestionPedidosApp.location.streetAddress')" for="location-streetAddress"></label>
            <input
              type="text"
              class="form-control"
              name="streetAddress"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('gestionPedidosApp.location.postalCode')" for="location-postalCode"></label>
            <input
              type="text"
              class="form-control"
              name="postalCode"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('gestionPedidosApp.location.city')" for="location-city"></label>
            <input
              type="text"
              class="form-control"
              name="city"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('gestionPedidosApp.location.stateProvince')" for="location-stateProvince"></label>
            <input
              type="text"
              class="form-control"
              name="stateProvince"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('gestionPedidosApp.location.country')" for="location-country"></label>
