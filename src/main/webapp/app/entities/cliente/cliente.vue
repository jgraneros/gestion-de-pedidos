<template>
  <div>
    <h2 id="page-heading" data-cy="ClienteHeading">
      <span v-text="t$('gestionPedidosApp.cliente.home.title')" id="cliente-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" v-on:click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('gestionPedidosApp.cliente.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'ClienteCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="t$('gestionPedidosApp.cliente.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && clientes && clientes.length === 0">
      <span v-text="t$('gestionPedidosApp.cliente.home.notFound')"></span>
    </div>
      ...
      <table class="table table-striped" aria-describedby="clientes">
        <thead>
          <tr>
            ...
            <th scope="row"><span v-text="t$('gestionPedidosApp.cliente.nombre')"></span></th>
            <th scope="row"><span v-text="t$('gestionPedidosApp.cliente.email')"></span></th>
            <th scope="row"><span v-text="t$('gestionPedidosApp.cliente.telefono')"></span></th>
            <th scope="row"></th>
          </tr>
        </thead>
        <tbody>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span id="gestionPedidosApp.cliente.delete.question" data-cy="clienteDeleteDialogHeading" v-text="t$('entity.delete.title')"></span>
      </template>
      <div class="modal-body">
        <p id="jhi-delete-cliente-heading" v-text="t$('gestionPedidosApp.cliente.delete.question', { id: removeId })"></p>
      </div>
