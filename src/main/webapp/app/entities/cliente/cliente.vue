        ...
        <thead>
          <tr>
            ...
            <th scope="row" v-on:click="changeOrder('nombre')">
              <span v-text="t$('gestionPedidosApp.cliente.nombre')"></span>
              <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'nombre'"></jhi-sort-indicator>
            </th>
            <th scope="row" v-on:click="changeOrder('email')">
              <span v-text="t$('gestionPedidosApp.cliente.email')"></span>
              <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'email'"></jhi-sort-indicator>
            </th>
            <th scope="row" v-on:click="changeOrder('telefono')">
              <span v-text="t$('gestionPedidosApp.cliente.telefono')"></span>
