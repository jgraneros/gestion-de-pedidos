...
import ar.com.threedland.pedidos.repository.ClienteRepository;
import ar.com.threedland.pedidos.service.dto.ClienteDTO;
import ar.com.threedland.pedidos.service.mapper.ClienteMapper;
...
class ClienteResourceIT {
    ...
    public static Cliente createEntity(EntityManager em) {
        Cliente cliente = new Cliente().nombre(DEFAULT_NOMBRE).email(DEFAULT_EMAIL).telefono(DEFAULT_TELEFONO);
        return cliente;
    }
    ...
    public static Cliente createUpdatedEntity(EntityManager em) {
        Cliente cliente = new Cliente().nombre(UPDATED_NOMBRE).email(UPDATED_EMAIL).telefono(UPDATED_TELEFONO);
        return cliente;
    }
    ...
    void putExistingCliente() throws Exception {
        ...
        updatedCliente.nombre(UPDATED_NOMBRE).email(UPDATED_EMAIL).telefono(UPDATED_TELEFONO);
    ...
    void partialUpdateClienteWithPatch() throws Exception {
        ...
        partialUpdatedCliente.nombre(UPDATED_NOMBRE);
    ...
    void fullUpdateClienteWithPatch() throws Exception {
        ...
        partialUpdatedCliente.nombre(UPDATED_NOMBRE).email(UPDATED_EMAIL).telefono(UPDATED_TELEFONO);
